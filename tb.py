...
def get_all_tb_price():
	...
	while i < pages:
	    page_num = i*60 
	    i = i + 1 
	    tb = tbSpider("https://s.taobao.com/list?spm=a21bo.50862.201867-links-0.38.7f35a3b33tWAVy&q="+product+"&style=grid&seller_type=taobao&bcoffset=12&s="+str(page_num),proxys)
